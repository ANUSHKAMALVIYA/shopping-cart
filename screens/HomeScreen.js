...
import {Text, TouchableOpacity, StyleSheet, Image, TextInput,Dimensions, FlatList,} from 'react-native';
...
const Card= ({product})=> {
  return (
    <View>
      <TouchableOpacity onPress={()=>navigation.navigate('Product',product)} activeOpacity={0.8}>
